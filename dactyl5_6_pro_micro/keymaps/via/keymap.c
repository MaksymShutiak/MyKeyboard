...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_ESC,     KC_A,   KC_S,    KC_D,      KC_F,       KC_G,       KC_SPC,         KC_PGUP,    KC_H,   KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT,    KC_Z,   KC_X,    KC_C,      KC_V,       KC_B,       KC_LCTL,        KC_PGDN,    KC_N,   KC_M,   KC_COMM,  KC_DOT,  KC_SLSH, KC_RSFT,
